...
export const modelSnapshots = sqliteTable(
  "model_snapshots",
  {
    ...
    upAskSize: real("up_ask_size").notNull().default(0),
    upBidSize: real("up_bid_size").notNull().default(0),
    downAskSize: real("down_ask_size").notNull().default(0),
    downBidSize: real("down_bid_size").notNull().default(0),
...
export const modelMarketOutcomes = sqliteTable("model_market_outcomes", {
  marketSlug: text("market_slug").primaryKey(),
  outcome: text("outcome", { enum: ["UP", "DOWN"] }).notNull(),
...
export const outcomeModels = sqliteTable("outcome_models", {
  id: integer("id").primaryKey(),
  status: text("status", { enum: ["COLLECTING", "TRAINED"] }).notNull().default("COLLECTING"),
  trainedAt: integer("trained_at").notNull(),
  snapshotCount: integer("snapshot_count").notNull().default(0),
  ...
  baselineBrierScore: real("baseline_brier_score"),
  featureNames: text("feature_names"),
  trees: text("trees"),
  config: text("config"),
  message: text("message").notNull(),
